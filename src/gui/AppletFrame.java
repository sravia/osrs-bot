...
public class AppletFrame extends JFrame implements AppletStub {
    ...
    public static CheckboxMenuItem players;
    ...
    public AppletFrame() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        Data.CLIENT_APPLET.setBounds(5, 5, 764, 574);
        this.setResizable(false);
        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        setTitle("DynaMac BETA : Loaded Runescape : Client " + Data.crcHash);
        ...
        players = new CheckboxMenuItem("Players");
        //players.setEnabled(false);

        viewMenu.add(players);
